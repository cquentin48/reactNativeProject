...
import { getImageofCard } from '../RoutesAPI';
    ...
    return (
      ...
      >
          ...
          <FlatList
            ...
            renderItem={({ item }) =>
             (<CardListElement id={item.key.toString()}
              navigation={this.props.navigation}

              imageURL={{uri: getImageofCard(item.key.toString())}}
